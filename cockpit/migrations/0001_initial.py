# Generated by Django 3.2 on 2021-04-24 12:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ativo', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='cockpit.ativos', verbose_name='ID Ativo')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
